...
import yester.message.processor.{NeedAnalysisMessageProcessor, CurriculumDevelopmentMessageProcessor, SummaryMessageProcessor, UserMessageProcessor, ConsultationMessageProcessor}
...
object Yester {
    def main(args: Array[String]) {
        ...
        val topicList = List("find-users-req","create-users-req", "summary-req", "need-analysis-start-req", "need-analysis-conclude-req", "need-analysis-consult-req",
            ...
            "cur-dev-draft-validate-req", "consult-start-pac-req", "consult-benchmark-req", "consult-final-draft-req", "consult-endorse-req")
