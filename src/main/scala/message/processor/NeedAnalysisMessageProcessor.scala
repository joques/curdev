        ...
        needAnalysisObjRes.onComplete {
            case Success(needAnalysisObj1) => {
                ...
                needAnalysisObj.consultations match {
                    case Some(consCol) => {
                        val naConsComp = new NAConsultationComponent(consultationObj.date, consultationObj.organization, Some(consultationObj.commitHash))
                        needAnalysisObj.consultations = Some(naConsComp :: consCol)
                    }
                    case None => {
                        val naConsComp1 = new NAConsultationComponent(consultationObj.date, consultationObj.organization, Some(consultationObj.commitHash))
            ...
            case Failure(naFailure) => {
                ...
                val naConsComp2 = new NAConsultationComponent(consultationObj.date, consultationObj.organization, Some(consultationObj.commitHash))
    ...
    def addNeedAnalysisSurvey(message: NeedAnalysisSurveyRequestMessage): Unit = {
        ...
        needAnalysisObjRes.onComplete {
            case Success(needAnalysisObj) => {
                ...
                needAnalysisObj.get.survey = Some(naSurvComp)
                val addSurveyOpRes = DBManager.addOrUpdateNeedAnalysis(surveyObj.devCode, needAnalysisObj.get)
    ...
    def addNeedAnalysisConclusion(message: NeedAnalysisConcludeRequestMessage): Unit = {
        ...
        needAnalysisObjRes.onComplete {
            case Success(needAnalysisObj) => {
                ...
                needAnalysisObj.get.conclusion = Some(naConclComp)
                val addConclusionOpRes = DBManager.addOrUpdateNeedAnalysis(conclusionObj.devCode, needAnalysisObj.get)
    ...
    def addNeedAnalysisBosRecommendation(message: NeedAnalysisBosRecommendRequestMessage): Unit = {
        ...
        needAnalysisObjRes.onComplete {
            case Success(needAnalysisObj) => {
                ...
                needAnalysisObj.get.bos = Some(naBosComp)
                val addBosRecommendationOpRes = DBManager.addOrUpdateNeedAnalysis(bosRecommendationObj.devCode, needAnalysisObj.get)
    ...
    def addNeedAnalysisSenateRecommendation(message: NeedAnalysisSenateRecommendRequestMessage): Unit = {
        ...
        needAnalysisObjRes.onComplete {
            case Success(needAnalysisObj) => {
                ...
                needAnalysisObj.get.senate = Some(naSenateComp)
