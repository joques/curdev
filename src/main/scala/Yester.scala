...
object Yester {
    def main(args: Array[String]) {
        ...
        val topicList = List("find-users-req","create-users-req", "summary-req", "need-analysis-start-req", "need-analysis-conclude-req", "need-analysis-consult-req",
            "need-analysis-survey-req", "need-analysis-bos-start-req", "need-analysis-bos-recommend-req", "need-analysis-senate-start-req", "need-analysis-senate-recommend-req", "need-analysis-apc-recommend-req",
