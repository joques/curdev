...
case class SimpleResponseMessage(messageId: String, operationError: Option[String], operationResult: Option[String]) extends ResponseMessage[String](messageId, operationError, operationResult)
