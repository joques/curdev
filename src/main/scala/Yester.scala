...
object Yester {
    def main(args: Array[String]) {
        ...
        val topicList = List("find-users-req","create-users-req", "summary-req", "need-analysis-start-req", "need-analysis-conclude-req", "need-analysis-consult-req", "need-analysis-bos-start-req", "need-analysis-bos-recommend-req", "need-analysis-senate-recommend-req", "cur-dev-amendment-from-bos-req", "cur-dev-submit-to-bos-req", "cur-dev-authorize-from-bos-req",
